    ...
    public static class ObjectMother
    {
        ...
        public static TextClassifierResult TextClassifierResult_CompleteLabeledExamples00
            = new TextClassifierResult(
                    textSnippet: new TextSnippet(text: CreateThirtyCompleteTokenizedExamples()[0].LabeledExample.Text),
                    label: CreateThirtyCompleteTokenizedExamples()[0].LabeledExample.Label,
                    indexes: CreateSimilarityIndexesForCompleteLabeledExample00(),
                    indexAverages: CreateSimilarityIndexAveragesForCompleteLabeledExample00()
                );
        ...
        public static List<SimilarityIndex> CreateSimilarityIndexesForCompleteLabeledExample00()
        {
            ...
            List<SimilarityIndex> similarityIndexes = new List<SimilarityIndex>()
            {
                ...
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[0].LabeledExample.Text, label: "en", value: 1),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[1].LabeledExample.Text, label: "en", value: 0.031696),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[2].LabeledExample.Text, label: "en", value: 0.017512),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[3].LabeledExample.Text, label: "en", value: 0.022472),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[4].LabeledExample.Text, label: "en", value: 0.017927),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[5].LabeledExample.Text, label: "en", value: 0.018717),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[6].LabeledExample.Text, label: "en", value: 0.014844),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[7].LabeledExample.Text, label: "en", value: 0.017185),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[8].LabeledExample.Text, label: "en", value: 0.024096),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[9].LabeledExample.Text, label: "en", value: 0.020548),

                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[10].LabeledExample.Text, label: "sv", value: 0.000741),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[11].LabeledExample.Text, label: "sv", value: 0),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[12].LabeledExample.Text, label: "sv", value: 0),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[13].LabeledExample.Text, label: "sv", value: 0.000802),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[14].LabeledExample.Text, label: "sv", value: 0.000745),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[15].LabeledExample.Text, label: "sv", value: 0),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[16].LabeledExample.Text, label: "sv", value: 0.000861),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[17].LabeledExample.Text, label: "sv", value: 0.00074),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[18].LabeledExample.Text, label: "sv", value: 0.000733),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[19].LabeledExample.Text, label: "sv", value: 0.000905),

                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[20].LabeledExample.Text, label: "dk", value: 0.002333),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[21].LabeledExample.Text, label: "dk", value: 0.000895),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[22].LabeledExample.Text, label: "dk", value: 0.000843),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[23].LabeledExample.Text, label: "dk", value: 0.004918),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[24].LabeledExample.Text, label: "dk", value: 0.001668),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[25].LabeledExample.Text, label: "dk", value: 0.003027),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[26].LabeledExample.Text, label: "dk", value: 0.002618),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[27].LabeledExample.Text, label: "dk", value: 0.00367),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[28].LabeledExample.Text, label: "dk", value: 0.002575),
                new SimilarityIndex(text: CreateThirtyCompleteTokenizedExamples()[29].LabeledExample.Text, label: "dk", value: 0.003934)
